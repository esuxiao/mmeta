...
#' Objects of this class contain the meta-data for generic functions: \code{SingleTable.modelFit}, 
#' \code{SingleTable.summary}, and \code{SingleTable.plot}.
...
#' @description This function conducts exact posterior inference based on the list created by \code{SingleTable.create()}.
#' @param sing_table_obj a list of components generated by \code{SingleTable.create()}.
